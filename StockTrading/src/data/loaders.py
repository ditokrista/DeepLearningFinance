...
def standardize_columns(df):
    ...
    Handles:
    - Alpha Vantage format: '1. open', '2. high', '3. low', '4. close', '5. volume'
    - Yahoo Finance format: 'Open', 'High', 'Low', 'Close', 'Volume'
    ...
    column_mapping = {
        ...
        '4. close': 'close',
        '5. volume': 'volume',
        # Yahoo Finance / Capitalized format
        'Open': 'open',
        'High': 'high',
        'Low': 'low',
        'Close': 'close',
...
def load_stock_data(symbol, data_dir=None):
    """
    Load stock price data from CSV file with automatic column standardization
    ...
    Returns:
        pd.DataFrame: Stock data with standardized column names and date column
    """
    if data_dir is None:
